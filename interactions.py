...
def stable_mass_transfer(bs, donor, accretor, self):
    ...
    self.secular_code.parameters.check_for_inner_RLOF = True #AB: Set to true for eccentric mass transfer
...
def perform_mass_equalisation_for_contact(bs, donor, accretor, self):
    ...
    # if abs(donor.mass - accretor.mass)> 1e-4|units.MSun: #could be better. see if problems arise
        ...
        self.secular_code.parameters.include_inner_RLOF_terms = True #AB: Set to True for eccentric mass transfer
