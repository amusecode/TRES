        ...
        while self.triple.time < self.tend:
            ...
            if not no_stellar_evolution:
                ...
                if (
                    ...
                    # and dt > 0.5*self.donor_timescale() #AB: Previous condition
                    and dt > 0.01*self.donor_timescale() #AB: This condition may still be 'too fast' for eccentric mass transfer, and needs to be checked more
                    # dt > minimum_time_step #AB: this condition has been checked to resolve eccentric mass transfer
                ):
