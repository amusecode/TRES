...
class Triple_Class:
    ...
    def __init__(self, stars, bins, correct_params, 
            stellar_code, relative_inclination, 
        ...
        self.stellar_code = stellar_code
        ...
        self.secular_code = setup_secular_code(triple_set, self.triple.time, stop_at_semisecular_regime)      
...
if __name__ == '__main__':
    ...
    triple_class_object = Triple_Class(stars, bins, correct_params, stellar_code, 
            ...
            opt["stop_at_unstable_mass_transfer"], opt["stop_at_eccentric_unstable_mass_transfer"],
