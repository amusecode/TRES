...
#    plt.plot(times_array_Myr, a_in_array_AU[0]*Mtot[0]/Mtot/a_in_array_AU, '.')
#    plt.ylabel(r'$relative error a_\mathrm{in}$')
#    plt.xlabel(r'$t/\mathrm{Myr}$')
...
#    plt.plot(times_array_Myr, a_out_array_AU[0]*Mtott[0]/Mtott/a_out_array_AU, '.')
#    plt.ylabel(r'$relative error a_\mathrm{out}$')
#    plt.xlabel(r'$t/\mathrm{Myr}$')
...
#    plt.xlabel(r'$\cos(g_\mathrm{out})$')
#    plt.ylabel(r'$e_\mathrm{in}$')
#    plt.show()
#    plt.close()
#
#    plt.plot(np.cos(g_in_array), np.cos(g_out_array))
#    plt.xlabel(r'$\cos(g_\mathrm{in})$')
#    plt.ylabel(r'$\cos(g_\mathrm{out})$')
#    plt.show()
#    plt.close()
#
...
#    plt.xlim(0, t_max_Myr)
#    plt.xlabel(r'$t/\mathrm{Myr}$')
#    plt.ylabel(r'$\cos(o_\mathrm{out})$')
#    plt.show()
#    plt.close()
#
