...
def parse_arguments():
    ...
    parser.add_option(
        "-E", "--Ein", dest="inner_eccentricity", type="float", default=0.1, help="inner eccentricity [%default]"
    )
    parser.add_option(
        "-e", "--Eout", dest="outer_eccentricity", type="float", default=0.5, help="outer eccentricity [%default]"
    )
    parser.add_option(
        "-i",
        "-I",
    ...
    parser.add_option("-z", "-Z", dest="metallicity", type="float", default=0.02, help="metallicity [%default] %unit")
    parser.add_option(
        "-t", "-T", unit=units.Myr, dest="tend", type="float", default=5.0 | units.Myr, help="end time [%default] %unit"
    )
    parser.add_option(
        "--initial_time",
        unit=units.Myr,
    ...
    parser.add_option("-N", dest="number", type="int", default=0, help="number ID of system [%default]")
    parser.add_option(
        "-r",
    ...
    parser.add_option(
        "--CE", dest="which_common_envelope", type="int", default=2, help="which common envelope modeling [%default]"
    )
    ...
    parser.add_option(
        "--stop_at_SN", dest="stop_at_SN", action="store_true", default=False, help="stop at supernova [%default] %unit"
    )
    # 0  No kick
    ...
    parser.add_option(
        "--max_CPU_time", dest="max_CPU_time", type="float", default=3600.0, help="max CPU time [%default] %unit"
    )

    parser.add_option(
        "--stellar_evolution_code", dest="SE_code", type="int", default=0, help="which stellar evolution [%default]"
    )

    parser.add_option(
        "-f", dest="file_name", type="string", default="TRES.hdf", help="file name[%default]"  # "TRES.txt"
    )
    parser.add_option("-F", dest="file_type", type="string", default="hdf5", help="file type[%default]")  # "txt"
    parser.add_option(
        "--dir_plots",
        dest="dir_plots",
        type="string",
